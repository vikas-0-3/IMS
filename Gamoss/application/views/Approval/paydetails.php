          ...
          <div class="row">
            ...
            <div class="col-lg-10">
                <div class="row">
                    ...
                    <div class="col-3">
                        <div class="media-dropzone">
                            <h3 class="media-dropzone__title media-sidebar__title">Payment Details</h3>
                            <p>Payment Status : <?= $allpurchase[0]["payment_status"]; ?></p>
                            <p>Payment Note : <?= $allpurchase[0]["payment_note"]; ?></p>
                            <p>Payment method : <?= $allpurchase[0]["payment_method"]; ?></p>
                            <p>Payment No : <?= $allpurchase[0]["payment_no"]; ?></p>
                            <br>
                        </div>
                    </div>
                    <div class="col-3">
