    ...
    <main class="main" id="skip-target">
      <div class="container">
        <div class="main-title-wrapper">
          <h2 class="main-title">HR Approval</h2>    
        </div>
        <div class="table-wrapper users-table white-block">
          <table class="categories-table" id="myTable">
            ...
            <tbody>
            <?php $count = 1; foreach($HRApproval as $pod) {  ?>
              <tr>
                <td><?= $count; ?></td>
                ...
                <td>
                  <span class="p-relative">
                    ...
                    <ul class="users-item-dropdown dropdown">
                      <li><a href="<?= base_url() ?>Approval/hrChangeStatusAccept/<?= $pod["po_id"] ?>">Accept</a></li>
                      <li><a href="<?= base_url() ?>Approval/hrChangeStatusReject/<?= $pod["po_id"] ?>">Reject</a></li>
                    </ul>
                  </span>
                </td>
