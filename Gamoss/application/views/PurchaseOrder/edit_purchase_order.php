<main class="main new-post-main" id="skip-target">
      <div class="container">
      <?= form_open_multipart('purchaseorder/editorder/'.$allpurchase["id"]); ?>
          <div class="main-title-wrapper">
            <h2 class="main-title">Edit Order</h2>
          ...
          <div class="row new-page__row">
            <div class="col-xl-12 col-md-12">
              <div class="main-content new-page-content">
                ...
                <div class="main-title-wrapper">
                  <h2 class="main-title">Edit Your Order</h2>
                ...
                <div class="row">
                    <div class="col-sm">
                        <label>
                            <div class="white-block" style="padding:0">
                                ...
                                <select class="select transparent-btn" class="vendor_id" name="vendor_id">
                                <?php foreach ($allvendor as $av) { ?>
                                    <option value="<?= $av["id"]; ?>" <?php if($allpurchase["vendor_id"] == $av["id"]) { ?> selected <?php } ?> ><?= $av["vendor_name"]; ?></option>
                                <?php } ?>
                                </select>
                            </div>
                        </label>
                    ...
                    <div class="col-sm">
                        ...
                        <input type="text" name="date_time" placeholder="Enter Datetime" value="<?= $allpurchase["date_time"] ?>" />
                        </label>
                    </div>
                    <div class="col-sm">
                        <label>
                        <span class="new-page-label">PO Number</span>
                        <input required type="text" name="po_number" placeholder="Enter PO Number" value="<?= $allpurchase["po_number"] ?>" >
                        </label>
                    </div>
                        ...
                        <div class="users-table table-wrapper">
                                ...
                                <tr>
                                    ...
                                    <td> &ensp;
                                        <!-- <div class="white-block">
                                            <select class="select transparent-btn" id="input_gst">
                            ...
                            <table class="library-table" >
                                ...
                                <?php foreach ($orderdetails as $od) { ?>
                                        <tr id="<?= $od["id"] ?>">
                                        <input type="hidden" name="deletedids[]" value="<?= $od["id"] ?>" >
                                            <td>&ensp;<input readonly type="text" name="po_item_name[]" value="<?= $od["item_name"] ?>" placeholder="Item Name"></td>
                                            <td>&ensp;<input readonly type="text" name="po_item_description[]" value="<?= $od["item_description"] ?>" placeholder="Item Description"></td>
                                            <td>&ensp;<input readonly type="text" name="po_hsn[]" value="<?= $od["item_hsn"] ?>" placeholder="HSN"></td>
                                            <td>&ensp;<input readonly type="text" name="po_quantity[]" value="<?= $od["item_quantity"] ?>" placeholder="Quantity"></td>
                                            <td>&ensp;<input readonly type="text" name="po_rate[]" value="<?= $od["item_rate"] ?>" placeholder="Rate"></td>
                                            <td>&ensp;<input readonly type="text" name="po_tax[]" value="<?= $od["item_tax"] ?>" placeholder="Tax"></td>
                                            <td>&ensp;<input readonly type="text" name="po_tax_type[]" value="<?= $od["item_tax_type"] ?>" placeholder="Tax Type"></td>
                                            <td>&ensp;<input readonly type="text" name="po_value[]" value="<?= $od["item_value"] ?>" placeholder="Value"></td>
                                            <td><button class="badge-trashed"  onclick="deleteTableRow(<?= $od['id'] ?>)" style="padding: 5px;">Delete</button></td>
                                        </tr>                                
                                <?php } ?>
                            ...
                            <div class="white-block">
                                ...
                                <p>Discount</p>
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            &ensp;
                                            <input type="number" placeholder="Discount" id="discount_value" name="discount_value" value="<?= $allpurchase['discount_amount'] ?>" onchange="calcTotal()">
                                        </div>
                                    </div>
                                ...
                                <p>Total <input type="number" placeholder="Total" value="<?= $allpurchase['total'] ?>" id="total_amount" name="total_amount" readonly ></p>
